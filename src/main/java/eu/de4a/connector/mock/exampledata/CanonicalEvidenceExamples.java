...
public enum CanonicalEvidenceExamples {
    ...
    T41_ES_A("53377873WA", new ClassPathResource("examples/T4.1-examples/SA-UC1-example-ES_A.xml"), DataOwner.UJI_ES, EvidenceID.HIGHER_EDUCATION_DIPLOMA, DE4AT41Marshaller.higherEducationDiploma(), USIAutoResponse.IMMEDIATE),
    ...
    T41_ES_B("53377873WB", new ClassPathResource("examples/T4.1-examples/SA-UC1-example-ES_B.xml"), DataOwner.UJI_ES, EvidenceID.HIGHER_EDUCATION_DIPLOMA, DE4AT41Marshaller.higherEducationDiploma(), USIAutoResponse.DELAY_5_SEC),
    ...
    T41_ES_C("53377873WC", new ClassPathResource("examples/T4.1-examples/SA-UC1-example-ES_C.xml"), DataOwner.UJI_ES, EvidenceID.HIGHER_EDUCATION_DIPLOMA, DE4AT41Marshaller.higherEducationDiploma(), USIAutoResponse.DELAY_40_SEC),
